...
if [ -z "$response" ]; then
	...
	# Download libs
	wget https://ajax.googleapis.com/ajax/libs/angularjs/1.4.7/angular.min.js -P public/js/libs/
	wget https://code.angularjs.org/1.4.7/angular.min.js.map -P public/js/libs/
	wget https://code.angularjs.org/1.4.7/angular-route.min.js -P public/js/libs/
	wget https://code.angularjs.org/1.4.7/angular-route.min.js.map -P public/js/libs/
...
module.exports.delete = function(req, res){
	...
	VERT="\\033[1;32m"
	echo '---------------------------------------------'
	echo -e "$VERT" "You application created to " "$response"
